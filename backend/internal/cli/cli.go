...
import (
	...
	"git.example.com/monitoring/cerbix/internal/agent"
	...
	"git.example.com/monitoring/cerbix/internal/httpsrv"
	"git.example.com/monitoring/cerbix/internal/ingest"
	"git.example.com/monitoring/cerbix/internal/logging"
	"git.example.com/monitoring/cerbix/internal/mailer"
	"git.example.com/monitoring/cerbix/internal/metrics"
	"git.example.com/monitoring/cerbix/internal/mqadmin"
	"git.example.com/monitoring/cerbix/internal/notify"
	"git.example.com/monitoring/cerbix/internal/outbox"
	...
	"git.example.com/monitoring/cerbix/internal/subscribe"
	"git.example.com/monitoring/cerbix/internal/web"
	"git.example.com/monitoring/cerbix/internal/webhook"
