...
| `func-change-intelligence.md` | A pipeline says what it changed, and the service's facts say what followed (FR-025/NFR-020, opened after iter-0163) | revision 3 (16 decisions, 23 invariants, §7 matrix, 7 owner questions answered) | DESIGN APPROVED (party [15], D-0209, iter-0164); implementation is iter-0165; no SPA code before an owner-approved UI mock |
