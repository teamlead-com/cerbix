...
| `func-reliability-gate-all-windows.md` | Worst-of-all-configured-windows gate evaluation without averaging healthy and unhealthy evidence (FR-035/NFR-029) | revision 1 APPROVED; policy schema v2, aggregation algebra, evidence and compatibility contract | DONE in iter-0186; downgrade and CLI evidence strengthened in iter-0188 |
| `func-onboarding.md` | The first truthful path from an authorized account to one real monitor result (FR-036/NFR-030) | revision 5 APPROVED; additive canonical-state Dashboard journey | DONE and owner-closed in iter-0187; async workspace fencing strengthened in iter-0188 |
| `func-status-pages-overall-status.md` | Compose component health and active-incident attention without publishing a false all-clear (FR-038/NFR-032) | revision 1 APPROVED 2026-09-21; complete copy/state/test matrix | IMPLEMENTED in iter-0191; post-close state-authority, matrix, vocabulary and live-copy hardening isolated in iter-0192/D-0263; frontend-only composition, API unchanged |
...
| `func-status-pages-incidents.md` | Service-first public status-page hierarchy, compact active incidents, and privacy-safe affected-component navigation (FR-037/NFR-031) | revision 1 APPROVED AND IMPLEMENTED 2026-09-21; D-0260/D-0261 | Shipped in iter-0189 and post-close hardened in iter-0190; evidence in [`iter-0189.md`](../iterations/iter-0189.md) and [`iter-0190.md`](../iterations/iter-0190.md) |
