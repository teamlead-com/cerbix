...
| FR-003 | Load and strictly validate a YAML config (reject unknown keys, fail fast). | DONE | [`backend/internal/config/config.go`](../backend/internal/config/config.go), [`config_test.go`](../backend/internal/config/config_test.go), [`packaging/config.example.yaml`](../backend/packaging/config.example.yaml) |
