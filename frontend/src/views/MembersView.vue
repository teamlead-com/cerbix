...
<template>
  <AppShell active="members" :crumbs="[ws.orgName || 'cerbix', 'Members']">
    <div class="mx-auto max-w-[1060px] px-[22px] pb-16 pt-6">
      <!-- page head -->
      <div class="mb-5 flex flex-wrap items-start gap-[14px]">
        <div>
          <h1 class="text-[21px] font-semibold tracking-tight">Members</h1>
      ...
      <!-- members table -->
      <section v-else class="rounded border border-border bg-surface shadow-card">
      ...
      <div class="mt-7">
        <div class="mb-3 flex items-center gap-[10px]">
          <h2 class="text-[13px] font-semibold">Role permissions</h2>
      ...
      <div v-if="canManage" class="mt-7">
        <div class="mb-3 flex items-center gap-[10px]">
          <h2 class="text-[13px] font-semibold">Audit log</h2>
