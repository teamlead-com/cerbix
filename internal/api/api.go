...
type Store interface {
	...
	ClaimPullJobsV4(ctx context.Context, region string, max, leaseSeconds int, workflowKinds []string) ([]store.PullJob, error)
	...
	RecordAgentCapabilities(ctx context.Context, region, agentID string, credentialEnvelope int, credentialReady bool, workflowKinds []string, ledger int) error
...
func (h *Handler) Router() *http.ServeMux {
	...
	mux.HandleFunc("GET /api/v1/projects/{projectID}/gate/policy", h.getProjectGatePolicy)
	mux.HandleFunc("PUT /api/v1/projects/{projectID}/gate/policy", h.putProjectGatePolicy)
	mux.HandleFunc("DELETE /api/v1/projects/{projectID}/gate/policy", h.deleteProjectGatePolicy)
